...
[private reporting form](https://github.com/ascillato/full-template-for-cpp-project-repository/security/advisories/new).
State clearly that the report concerns community conduct rather than a software vulnerability.

If private reporting is unavailable, contact the repository owner through the contact methods on
the [maintainer's GitHub profile](https://github.com/ascillato). Do not open a public issue containing
...
external channels such as social media. Violating these terms may lead to a temporary or permanent
ban.
